...
public interface ConstantsBase {
	...
	String DATABASE_NAME = "ensa-notes";
	String APP_STORAGE_DIRECTORY_SB_SYNC = "db_sync";

	String DEV_EMAIL = "ensanotes@ensa.ma";
	String GOOGLE_PLUS_COMMUNITY = "https://plus.google.com/";
	String FACEBOOK_COMMUNITY = "https://www.facebook.com/nadir.bensaid.92";

	// Used for updates retrieval
	long UPDATE_MIN_FREQUENCY = 24L * 60L * 60L * 1000L; // 1 day
	String DRIVE_FOLDER_LAST_BUILD = "https://goo.gl/#";
