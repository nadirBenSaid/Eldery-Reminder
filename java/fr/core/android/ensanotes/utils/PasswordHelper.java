...
public class PasswordHelper {
    ...
    public static void resetPassword(final Activity mActivity) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(mActivity)
                .title(ensaNotes.getSharedPreferences().getString(Constants.PREF_PASSWORD_QUESTION, ""))
                ...
                .onPositive((dialogElement, which) -> {
                    ...
                    String oldAnswer = ensaNotes.getSharedPreferences().getString(Constants.PREF_PASSWORD_ANSWER, "");
    ...
    public static void removePassword() {
        Observable
                ...
                .doOnCompleted(() -> {
                    ...
                    ensaNotes.getSharedPreferences().edit()
