    ...
    public static Spanned[] parseTitleAndContent(Context mContext, Note note) {
        ...
        if (note.isChecklist() && !TextUtils.isEmpty(contentText)) {
			contentSpanned = Html.fromHtml(contentText
                    .replace(fr.core.android.checklistview.interfaces.Constants.CHECKED_SYM,
							fr.core.android.checklistview.interfaces.Constants.CHECKED_ENTITY)
                    .replace(fr.core.android.checklistview.interfaces.Constants.UNCHECKED_SYM,
							fr.core.android.checklistview.interfaces.Constants.UNCHECKED_ENTITY)
