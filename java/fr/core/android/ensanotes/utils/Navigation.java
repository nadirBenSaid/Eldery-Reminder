...
public class Navigation {
    ...
    public static int getNavigation() {
        String[] navigationListCodes = ensaNotes.getAppContext().getResources().getStringArray(R.array.navigation_list_codes);
    ...
    public static String getNavigationText() {
        Context mContext = ensaNotes.getAppContext();
    ...
    public static Long getCategory() {
        if (getNavigation() == CATEGORY) {
			return Long.valueOf(ensaNotes.getAppContext().getSharedPreferences(Constants.PREFS_NAME, Context
