 ...
 */
package fr.core.android.ensanotes.db;
...
import fr.core.android.ensanotes.async.upgrade.UpgradeProcessor;
...
public class DbHelper extends SQLiteOpenHelper {
	...
	public static synchronized DbHelper getInstance() {
		return getInstance(ensaNotes.getAppContext());
	}
    ...
    public Note updateNote(Note note, boolean updateLastModification) {
        ...
        Log.d("Info : getCategory", note.getCategory() != null ? note.getCategory().getName() : "");

        // To make sure the note and attachments inserted are atomical and boost performances transaction are used
        db.beginTransaction();
    ...
    public List<Note> getNotesByUncompleteChecklist() {
		String whereCondition = " WHERE " + KEY_CHECKLIST + " = 1 AND " + KEY_CONTENT + " LIKE '%" + fr.core.android
