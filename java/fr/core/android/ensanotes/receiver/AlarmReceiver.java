 ...
 */
package fr.core.android.ensanotes.receiver;
...
import fr.core.android.ensanotes.SnoozeActivity;
import fr.core.android.ensanotes.db.DbHelper;
import fr.core.android.ensanotes.models.Note;
import fr.core.android.ensanotes.services.NotificationListener;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	private void createNotification(Context mContext, Note note) {
		...
		notificationsHelper.getBuilder()
				.addAction(R.drawable.ic_material_reminder_time_light, fr.core.android.ensanotes.utils.TextHelper
						.capitalize(mContext.getString(R.string.snooze)) + ": " + snoozeDelay, piSnooze)
				.addAction(R.drawable.ic_remind_later_light,
						fr.core.android.ensanotes.utils.TextHelper.capitalize(mContext.getString(R.string
