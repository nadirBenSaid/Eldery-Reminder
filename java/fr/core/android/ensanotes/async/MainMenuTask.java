...
import fr.core.android.ensanotes.models.NavigationItem;
import fr.core.android.ensanotes.models.adapters.NavDrawerAdapter;
import fr.core.android.ensanotes.models.misc.DynamicNavigationLookupTable;
import fr.core.android.ensanotes.models.views.NonScrollableListView;
import fr.core.android.ensanotes.utils.Constants;
import fr.core.android.ensanotes.utils.Navigation;
...
public class MainMenuTask extends AsyncTask<Void, Void, List<NavigationItem>> {
    ...
    protected void onPostExecute(final List<NavigationItem> items) {
        ...
        if (isAlive()) {
            ...
            mDrawerList.setOnItemClickListener((arg0, arg1, position, arg3) -> {
                ...
                Log.d(Constants.TAG, "navigationx : " + navigation);
				if (mainActivity.updateNavigation(navigation) && !StaticExceptions(navigation)) {
    ...
    private List<NavigationItem> buildMainMenu() {
        ...
        String mNavigationArray_str = Arrays.toString(mNavigationArray);
        Log.e(Constants.TAG, "mNavigationArray_strx: " + mNavigationArray_str);
        ...
        for (int i = 0; i < mNavigationArray.length; i++) {
            if (!checkSkippableItem(i) && !StaticExceptions(mNavigationArray[i])) {
    ...
    private boolean StaticExceptions(String nav_tab) {
        ...
        Log.e(Constants.TAG, "StaticExceptions 1 : " + bool_skippable + " : " + mNavigationArray_strx);
    ...
    private boolean checkSkippableItem(int i) {
        ...
        switch (i) {
            ...
            case Navigation.TRASH:
                ...
                break;
			default:
				Log.e(Constants.TAG, "Feature not found: " + i);
        }
        return skippable;
    }
