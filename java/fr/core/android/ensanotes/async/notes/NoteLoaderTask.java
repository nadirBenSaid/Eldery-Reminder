...
import fr.core.android.ensanotes.async.bus.NotesLoadedEvent;
import fr.core.android.ensanotes.db.DbHelper;
import fr.core.android.ensanotes.exceptions.NotesLoadingException;
...
public class NoteLoaderTask extends AsyncTask<Object, Void, ArrayList<Note>> {
	...
	protected ArrayList<Note> doInBackground(Object... params) {
		...
		Log.d(Constants.TAG, "Eggnogs3 : " + methodName);
