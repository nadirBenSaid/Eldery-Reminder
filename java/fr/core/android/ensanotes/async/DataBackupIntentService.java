...
import fr.core.android.springpadimporter.Importer;
import fr.core.android.springpadimporter.models.SpringpadAttachment;
import fr.core.android.springpadimporter.models.SpringpadComment;
import fr.core.android.springpadimporter.models.SpringpadElement;
import fr.core.android.springpadimporter.models.SpringpadItem;
        ...
        for (SpringpadElement springpadElement : importer.getNotes()) {
            ...
            if (springpadElement.getType().equals(SpringpadElement.TYPE_CHECKLIST)) {
                ...
                for (SpringpadItem mSpringpadItem : springpadElement.getItems()) {
                    checkmark = mSpringpadItem.getComplete() ? fr.core.android.checklistview.interfaces.Constants
                            .CHECKED_SYM
                            : fr.core.android.checklistview.interfaces.Constants.UNCHECKED_SYM;
