...
package fr.core.android.ensanotes.intro;
...
public class IntroActivity extends AppIntro2 {
	...
	public void onDonePressed() {
		ensaNotes.getAppContext().getSharedPreferences(Constants.PREFS_NAME, Context.MODE_MULTI_PROCESS).edit()
	...
	public static boolean mustRun() {
		return !ensaNotes.isDebugBuild() && !ensaNotes.getAppContext().getSharedPreferences(Constants.PREFS_NAME,
