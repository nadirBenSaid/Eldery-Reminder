...
import fr.core.android.analitica.AnalyticsHelper;
import fr.core.android.ensanotes.async.DataBackupIntentService;
import fr.core.android.ensanotes.helpers.AppVersionHelper;
import fr.core.android.ensanotes.helpers.LanguageHelper;
...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null && getArguments().containsKey(XML_NAME)) {
			xmlId = ResourcesUtils.getXmlId(ensaNotes.getAppContext(), ResourcesUtils.ResourceIdentifiers.xml, String
...
//		});
		...
		if (changelog != null) {
			changelog.setOnPreferenceClickListener(arg0 -> {
				...
				((ensaNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_changelog");
				...
				new MaterialDialog.Builder(getActivity())
						...
						.callback(new MaterialDialog.ButtonCallback() {
							...
							public void onPositive(MaterialDialog materialDialog) {
								...
								((ensaNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_tour_show_again");
...
//        }
					...
					new MaterialDialog.Builder(getActivity())
							...
							.callback(new MaterialDialog.ButtonCallback() {
								...
								public void onPositive(MaterialDialog materialDialog) {
									...
									((ensaNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING,
	...
	private void export(View v) {
		...
		new MaterialDialog.Builder(getActivity())
				...
				.callback(new MaterialDialog.ButtonCallback() {
					@Override
					public void onPositive(MaterialDialog materialDialog) {
						((ensaNotes)getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_export_data");
	...
	@Override
	public void onStart() {
		((ensaNotes)getActivity().getApplication()).getAnalyticsHelper().trackScreenView(getClass().getName());
		super.onStart();
	}
