...
package fr.core.android.ensanotes.models.views;
...
import fr.core.android.ensanotes.models.listeners.AbsListViewScrollDetector;
import fr.core.android.ensanotes.models.listeners.OnFabItemClickedListener;
...
public class Fab {
    ...
    public void setOverlay(int colorResurce) {
        View overlayView = new View(ensaNotes.getAppContext());
