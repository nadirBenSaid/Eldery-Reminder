 ...
 */
package fr.core.android.ensanotes.helpers.date;
...
public class DateHelper {
    ...
    public static String getNoteReminderText(long reminder) {
        return ensaNotes.getAppContext().getString(R.string.alarm_set_on) + " " + getDateTimeShort(ensaNotes
				.getAppContext(), reminder);
    }


    public static String getNoteRecurrentReminderText(long reminder, String rrule) {
        return DateHelper.formatRecurrence(ensaNotes.getAppContext(), rrule) + " " + ensaNotes.getAppContext().getString
                (R.string.starting_from) + " " + DateHelper.getDateTimeShort(ensaNotes.getAppContext(), reminder);
    }


	public static String getFormattedDate(Long timestamp, boolean prettified) {
		if(prettified) {
			return fr.core.android.ensanotes.utils.date.DateUtils.prettyTime(timestamp);
		} else {
			return DateHelper.getDateTimeShort(ensaNotes.getAppContext(), timestamp);
		}
	}
