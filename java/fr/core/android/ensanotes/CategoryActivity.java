...
import fr.core.android.ensanotes.async.bus.CategoriesUpdatedEvent;
...
public class CategoryActivity extends AppCompatActivity implements ColorChooserDialog.ColorCallback{
        ...
        new MaterialDialog.Builder(this)
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        if (!StaticExceptions(String.valueOf(category.getName()))){
                            ...
                            BaseActivity.notifyAppWidgets(ensaNotes.getAppContext());
    ...
    private boolean StaticExceptions(String nav_tab) {
        ...
        String[] mNavigationException = getResources().getStringArray(R.array.navigation_list_static);
